...
<html lang="fr">
    ...
    <body>
        <!-- Corps de la page -->
        <header>
            <img id="logoPage" alt="Logo de Sport Track" src="img/logo.svg">
            <hr id="sepHeader">
            <nav id="barreNav">
                <ul>
                    <li class="elementBarreNav"><a href="home.php">Accueil</a></li>
        ...
        <main>
            ...
            <section class="sectionPage">
                <form class="formulaire" action="handle-login.php" method="post">
                ...
                <p class="linkToAnother"><a href="signup.php">Inscription</a></p>
            </section>
        </main>
        <footer>
            ...
            <section id="sectionLogoFooter">
                <img alt="logoSportTrack" src="img/logo-white.svg" id="footerLogo">
            </section>
